...
Next, one or more sampling frameworks must be chosen. There are 6 to choose from in the updated version of rSPACE, with the first 3 being original. 

```{r sampling framework options, include = FALSE}
